...
class ScottDayViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func loadEvents() {
        calendarsLocal = eventStoreLocal.calendarsForEntityType(EKEntityType.Event)
        ...
        let predicate = eventStoreLocal.predicateForEventsWithStartDate(beginningDate, endDate: endDate, calendars: calendarsLocal)
    ...
    func checkEventsOnCalendar(startTime: Int) -> Int {
        ...
        let predicate = eventStoreLocal.predicateForEventsWithStartDate(beginDate, endDate: endDate, calendars: calendarsLocal)
